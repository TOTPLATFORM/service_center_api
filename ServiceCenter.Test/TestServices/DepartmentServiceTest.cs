...
public class DepartmentServiceTest
{
    ...
    [InlineData("Department Test adfa2")]
    public async Task AddDepartment(string DepartName)
    {
        // Arrange
        CheckService();
    ...
    public async Task GetAllDepartments()
    {
        ...
        // Act
        var result = await _departmentService.GetAllDepartmentsAsync(2,1);
    ...
    /// <summary>
    /// Tests the search functionality in the Department service to ensure it can find Department based on a search term.
    /// </summary>
    [Fact, TestPriority(5)]
    public async Task GetAllEmployeesForSpecificDepartment()
    {
        // Arrange
        CheckService();
        int departmentId =1;
        ...
        // Act
        var result = await _departmentService.GetAllEmployeesForSpecificDepartmentAsync(departmentId, 2, 1);
    ...
    public async Task SearchDepartment()
    {
        ...
        // Act
        var result = await _departmentService.SearchDepartmentByTextAsync(text, 2, 1);
