...
public class InventoryServiceTest
{
    ...
    public async Task GetAllInventory()
    {
        ...
        // Act
        var result = await _inventoryService.GetAllInventoriesAsync(2,1);
    ...
    /// <summary>
    /// Tests the search functionality in the inventory service to ensure it can find inventory based on a search term.
    /// </summary>
    [Fact, TestPriority(4)]
    public async Task SearchInventories()
    {
        ...
        // Act
        var result = await _inventoryService.SearchInventoryByTextAsync(text, 2, 1);
