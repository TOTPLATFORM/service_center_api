...
public class FeedbackServiceTest
{
    ...
    [InlineData("Desc1", "Product", "03:00:00", "53ae72a7-589e-4f0b-81ed-4038169498")]
    ...
    public async Task Updatefeedback(int id, bool expectedResult)
    {
        // Arrange
        CheckService();
        var feedbackRequestDto = new FeedbackRequestDto { FeedbackDescription = "feedbackDesc", FeedbackCategory = "feedbackCategory", FeedbackDate = DateOnly.Parse("09:09:30"), CustomerId = "53ae72a7-589e-4f0b-81ed-4038169498" };
