...
public interface IRevenueService : IApplicationService, IScopedService
{
	...
	/// </summary>
	/// <param name = "itemCount" > item count of revenue to retrieve</param>
	///<param name="index">index of revenue to retrieve</param>
	...
	public Task<Result<PaginationResult<RevenueResponseDto>>> GetAllRevenuesAsync(int itemCount, int index);

	/// <summary>
	/// asynchronously retrieves all revenues in the system.
	/// </summary>
	/// <param name = "transactionType" > transaction type to retrieve</param>
	/// <param name = "itemCount" > item count of revenue to retrieve</param>
	///<param name="index">index of revenue to retrieve</param>
	/// <returns>a task that represents the asynchronous operation, which encapsulates the result containing a list of revenue response DTOs.</returns>
	public Task<Result<PaginationResult<RevenueResponseDto>>> GetAllRevenuesByTransactionTypeAsync(TransactionType transactionType, int itemCount, int index);
	...
	public Task<Result<PaginationResult<RevenueResponseDto>>> SearchRevenuesByTextAsync(DateOnly date, int itemCount, int index);
	/// <summary>
